...
help() {
  ...
  echo "  refresh-tokens"
  echo "  create-tenant-basic-registration"
  echo "  create-tenant-advanced-registration"
...
"create-tenant-basic-registration")
  create_tenant_registration "basic"
  ;;

"create-tenant-advanced-registration")
  create_tenant_registration "advanced"
  ;;
